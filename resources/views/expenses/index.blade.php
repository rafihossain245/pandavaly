                        ...
                        <div class="filter-content">
                            <div class="closest filter-row">
                                ...
                                <div class="filter-group">
                                    ...
                                    <select id="expense_category_id" name="expense_category_id" onchange="getExpSubCategory(this, '#expense_sub_category_id')" data-action="{{ route('role.get-expense-sub-category', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" class="form-control select2" style="width: 100%">
                                        <option value="">All</option>
                                ...
                                <div class="filter-group">
                                    <label for="expense_sub_category_id">Expense SubCategory</label>
                            ...
                            <div class="closest filter-row">
                                ...
                                <div class="filter-group">
                                    ...
                                    <input type="text" name="title" value="{{ request('title') }}" id="title" class="form-control" placeholder="Enter title">
                                </div>
                            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($datas as $key => $value)                       
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        {{ $value->expense_sub_category?->name }}                                                                                                                        
                                    </td>                                                                          
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $value->expense_date }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $value->amount }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $value->payment_mode }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($value->status)
