...
@section('main-content')
        ...
        <div class="states-table-container">
            <div class="states-table-header bg-blue-600 px-6 py-4 flex justify-between items-center">
                <h2 class="states-table-title text-white text-xl font-semibold" style="color: white">
                    <i class="fas fa-list mr-2"></i>Unit List
                </h2>
                        ...
                        <div class="filter-content">
                            <div class="closest filter-row">                             
                                ...
                                <div class="filter-group">
                                    ...
                                    <input type="text" name="symbol" value="{{ request('symbol') }}" id="symbol" class="form-control" placeholder="Enter symbol">
                                </div>
                                <div class="filter-group">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($datas as $key => $value)                       
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $value->symbol }}</td>
    ...
    @include('units.create-modal')
    @include('units.edit-modal')
    @include('units.delete-modal')
...
@section('js')
    ...
    <script>
        ...
        function validateCreateForm() {
            ...
            if (!$('#create_symbol').val().trim()) {
                $('#create_symbol').next('.error-message').removeClass('hidden');
                $('#create_symbol').addClass('border-red-500');
                isValid = false;
            }                                                                           
        ...
        function validateEditForm() {
            ...
            if (!$('#edit_symbol').val().trim()) {
                $('#edit_symbol').next('.error-message').removeClass('hidden');
                $('#edit_symbol').addClass('border-red-500');
                isValid = false;
            }        
