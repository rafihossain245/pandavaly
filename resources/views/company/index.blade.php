                ...
                <div class="table-responsive overflow-x-auto" style="padding: 15px">
                    <table class="table table-hover min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th style="width: 10%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Image</th>
                                <th style="width: 10%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Name</th>
                                <th style="width: 10%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Info</th>                                
                                <th style="width: 10%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Website</th>
                                <th style="width: 25%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Address</th>
                                <th style="width: 15%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Joined</th>
                            ...
                            @forelse ($datas as $key => $value)                       
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <img src="{{ asset($value->logo) }}" alt="" style="width: 50px;">
                                    </td> 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="{{ $value->website ?? '#' }}" target="_blank" style="color: #007bff; text-decoration: underline">Link</a>    
                                    </td>                                                                     
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="btn-group btn-group-sm flex space-x-1">
                                            <button class="btn btn-outline-primary edit-btn border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white px-3 py-1 rounded-md transition duration-200" 
                                                data-item_name="{{ $value->name }}" data-item_address="{{ $value->address }}" data-item_email="{{ $value->email }}" data-item_phone="{{ $value->phone }}" data-item_website="{{ $value->website }}" data-item_logo="{{ $value->logo }}" data-item_status="{{ $value->status }}" data-item_id="{{ $value->id }}" 
                                                data-action="{{ route('role.company-settings.update', ['role' => Str::slug(Auth::user()->getRoleNames()->first()), 'company_setting' => $value->id]) }}" title="Edit Item">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-btn').click(function() {
                ...
                const item_email = $(this).data('item_email');
                const item_phone = $(this).data('item_phone');
                const item_address = $(this).data('item_address');
                const item_website = $(this).data('item_website');
                const item_logo = $(this).data('item_logo');
                const item_status = $(this).data('item_status');
                ...
                $('#preview_logo').attr('src', item_logo ? (window.location.origin)+'/'+item_logo : '/default-logo.png');
                $('#edit_status').prop('checked', item_status == 1 ? true : false);
