...
@section('meta-information')
    <title>Whatsapp marketing Create</title>
@endsection

@section('main-content')
<div class="bg-white p-8 mt-1">
    <h2 class="text-2xl font-semibold mb-6 text-gray-700">Add Whatsapp marketing</h2>
    ...
    <form action="{{ route('role.whatsapp-marketing.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <textarea name="message" id="body" rows="3"
