...
@section('meta-information')
    <title>Sms Campaign List</title>
@endsection

@section('main-content')

<div class="bg-white p-6 rounded shadow">
    <h2 class="text-2xl font-semibold mb-4">Sms Campaign</h2>

    {{-- Top Bar with Create Button and Filter Form --}}
    <div class="flex justify-between items-center mb-4">

        <form method="GET" action="{{ route('role.whatsapp-marketing.index', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" class="flex space-x-4">
        ...
        <a href="{{ route('role.whatsapp-marketing.create', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}"
            ...
            <tbody>
                @forelse($campaigns as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-2 px-4 border-b">{{ $item->schedule_at }}</td>
