                            ...
                            @forelse ($datas as $key => $value)                       
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($value->icon)
                                            <img src="{{ asset($value->icon) }}" alt="{{ $value->name }}" class="h-10 w-10 object-cover rounded-full">
                                        @else
                                            N/A
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($value->image_path)
                                            <img src="{{ asset($value->image_path) }}" alt="{{ $value->name }}" class="h-10 w-10 object-cover rounded-full">
                                        @else
                                            N/A
                                        @endif
                                    </td>                                                                           
