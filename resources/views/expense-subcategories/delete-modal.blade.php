    ...
    <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="modal-footer flex justify-end pt-2">
                ...
                <button id="confirmDeleteBtn" data-action="{{ route('role.expense-subcategories.destroy', ['role' => Str::slug(Auth::user()->getRoleNames()->first()), 'expense_subcategory' => 1]) }}" class="btn btn-danger px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition duration-200">
                    Delete
                </button>
            </div>
        </div>
