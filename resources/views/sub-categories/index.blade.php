...
@section('main-content')
        ...
        <div class="states-table-container">
            <div class="states-table-header bg-blue-600 px-6 py-4 flex justify-between items-center">
                <h2 class="states-table-title text-white text-xl font-semibold" style="color: white">
                    <i class="fas fa-list mr-2"></i>Sub Category List
                </h2>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($datas as $key => $value)                       
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $value->category?->name }}</td>                                                                            
    ...
    @include('sub-categories.create-modal')
    @include('sub-categories.edit-modal')
    @include('sub-categories.delete-modal')
...
@section('js')
    ...
    <script>
        ...
        function validateCreateForm() {
            ...
            if (!$('#create_category_id').val() || ($('#create_category_id').val() == '') || ($('#create_category_id').val() == null)) {
                $('#create_category_msg').removeClass('hidden');                
                isValid = false;
            }
        ...
        function validateEditForm() {
            ...
            if (!$('#edit_category_id').val() || ($('#edit_category_id').val() == '') || ($('#edit_category_id').val() == null)) {
                $('#edit_category_msg').removeClass('hidden');                
                isValid = false;
            }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.reset-btn').addEventListener('click', function (e) {
                e.preventDefault();
                window.location = '{{ route('role.sub-categories.index', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}';
            });
        });
    </script>
@endsection