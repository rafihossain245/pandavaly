        ...
        <div class="states-table-container">
            <div class="states-table-header bg-blue-600 px-6 pb-4 flex justify-between items-center">
                <h2 class="states-table-title text-white text-xl font-semibold" style="color: white">
                    <i class="fas fa-edit mr-2"></i> Return Sale #{{ $sale->invoice_no }}
                </h2>
            ...
            <div class="states-table-content" style="padding: 15px;">
                <div class="sale-modal-body modal-body overflow-y-auto mt-2">
                    <form class="closest" id="saleEditForm" action="{{ route('role.return-refs.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4" style="justify-content: center">   
                            ...
                            <div class="mb-2">
                                ...
                                <input type="date" id="return_date" required value="{{ date('Y-m-d') }}" name="return_date" class="form-input w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div class="mb-2">
                                <label for="return_no" class="block text-gray-700 text-sm font-bold mb-2">Return No.</label>
                                <input type="text" readonly value="{{ $nextreturn }}" class="form-input w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div class="mb-2">
                            ...
                            <div>    
                                        ...
                                        <div class="product-card card_no{{ $detail->product_id }} bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex justify-between items-center">
                                            ...
                                            <div class="flex items-center space-x-6">                                                
                                                <div class="text-left" style="margin: 0">
                                                    ...
                                                    <input type="number" min="1" value="0" data-product_id="{{ $detail->product_id }}" onkeyup="setTotalAmount(this)" name="return_quantity[]" style="width: 120px" class="form-input px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                                </div>
                                                ...
                                                <div class="text-center" style="margin: 0">
                                                    ...
                                                    <p class="font-medium text-blue-600">৳<span class="item_Subtotal">{{ 0 }}</span></p>
                                                    <input type="hidden" name="subtotal[]" class="itemSubtotal" value="{{ 0 }}">
                                                </div>
                                            </div>
                                        </div>
                                    @empty
                                ...
                                <div class="space-y-4 my-4">  
                                    <div class="flex justify-end items-center">
                                        ...
                                        <span class="text-xl font-bold text-blue-600">৳ <span class="total_amount">{{ 0 }}</span></span>
                                        <input type="hidden" name="total_amount" id="total_amount" value="{{ 0 }}">
                                    </div>
                                </div>
                                <div class="space-y-4 mt-4" style="margin-top: 60px">                                                                     
                                    <textarea name="note" class="w-full border px-3 py-2 rounded" rows="5" placeholder="Write reason here..." style="border-color: #d4d3d3; background: white;"></textarea>
                                </div>
                            </div>                                                        
                        </div>
