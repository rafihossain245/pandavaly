                    ...
                    <form class="closest" id="transferCreateForm" action="{{ route('role.stock-transfers.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <select id="from_warehouse_id" name="from_warehouse_id" class="form-select w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 select2" style="width: 100%">
                                    @foreach ($warehouses as $wh)
                                        <option value="{{ $wh->id }}" {{ $loop->first ? 'selected' : '' }}>{{ $wh->name }} ({{ $wh->code }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-2">
                                ...
                                <select id="to_warehouse_id" name="to_warehouse_id" class="form-select w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 select2" style="width: 100%">
                                    @foreach ($warehouses as $wh)
                                        <option value="{{ $wh->id }}" {{ $loop->last ? 'selected' : '' }}>{{ $wh->name }} ({{ $wh->code }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4" style="justify-content: center">                               
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" id="qty" min="0.01" step="0.01" value="1" name="qty" class="form-input w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div class="mb-2">
                                ...
                                <div class="space-y-4">
                                    ...
                                    placeholder="Write ..." style="background: white;"></textarea>
                                </div>
                            </div>
                        </div>                                                                     
