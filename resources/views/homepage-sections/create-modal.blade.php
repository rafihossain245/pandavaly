            ...
            <div class="modal-body">
                <form id="createForm" action="{{ route('role.homepage-sections.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" method="POST">
                    ...
                    <div id="create_product_row_fields" class="type-fields border-t pt-4 mt-2">
                        ...
                        <div class="mb-4">
                            <label for="create_layout" class="block text-gray-700 text-sm font-bold mb-2">Layout</label>
                            <select id="create_layout" name="layout" class="form-select w-full px-3 py-2 border border-gray-300 rounded-md">
                    ...
                    <div id="create_feature_strip_fields" class="type-fields border-t pt-4 mt-2">
                        ...
                        <div id="create_feature_rows"></div>
                        <button type="button" class="add-feature-row text-sm text-blue-600" data-prefix="create">
                            <i class="fas fa-plus"></i> Add badge
                        </button>
                    </div>

                    <div id="create_testimonials_fields" class="type-fields border-t pt-4 mt-2">
                        <div class="mb-4">
                            <label for="create_testimonial_source" class="block text-gray-700 text-sm font-bold mb-2">Testimonial Source</label>
                            <select id="create_testimonial_source" name="source" class="testimonial-source form-select w-full px-3 py-2 border border-gray-300 rounded-md" data-prefix="create">
                                <option value="manual">Curated (written below)</option>
                                <option value="reviews">Real approved product reviews</option>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label for="create_testimonial_limit" class="block text-gray-700 text-sm font-bold mb-2">How many to show</label>
                            <input type="number" id="create_testimonial_limit" name="limit" min="1" max="50" value="3"
                                class="testimonial-limit form-input w-full px-3 py-2 border border-gray-300 rounded-md">
                        </div>
                        <div id="create_testimonial_manual_wrap">
                            <div id="create_testimonial_rows"></div>
                            <button type="button" class="add-testimonial-row text-sm text-blue-600" data-prefix="create">
